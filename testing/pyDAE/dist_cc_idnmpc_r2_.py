...
from sample_mods.distc_pyDAE.dist_cc_r2 import mod
...
def main():
    ...
    e.cycleSamPlant()
    stat = e.solve_dyn(e.PlantSample, stop_if_nopt=True, halt_on_ampl_error=False, l1_mode=True, bound_push=1e-2)
    ...
    for i in range(0, 4000):
        ...
        for j in range(5, 10):
            epsi = 10 ** (-1 - j)
            e.PlantSample.epsi.set_value(epsi)
            stat = e.solve_dyn(e.PlantSample, stop_if_nopt=False, l1_mode=True, bound_push=1E+00,
        ...
        for j in range(5, 10):
            ...
            if stat_nmpc == 0:
                ...
                break
        if stat_nmpc != 0:
            e.olnmpc.write(filename="failed_nmpc.nl", io_options={"symbolic_solver_labels": True})
        ...
        #                         skip_update=False,
        #                         tag="olnmpc",
        #                         stop_if_nopt=False, bound_push=1E-01,
