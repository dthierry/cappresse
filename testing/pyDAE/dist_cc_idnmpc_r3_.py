...
from sample_mods.distc_pyDAE.dist_cc_r1 import mod
...
def main():
    ...
    ref_state = {("x", (1,)): 0.0}  #: low reboiler heat, vapor above feed.
    ds = {}
