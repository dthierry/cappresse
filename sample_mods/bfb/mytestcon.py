...
def fl_irule(m, j, k):
    h0 = sum(m.hi_x[i] for i in range(0, j))
...
def ic_ngb_rule(m, ix, jx, c):
    if 0 < jx <= m.ncp_x:
        return m.Ngb[0, 0, ix, jx, c] == m.Ngb_ic[(ix, jx, c)]
    else:
        return Constraint.Skip

def ic_hgb_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.Hgb[0, 0, ix, jx] == m.Hgb_ic[(ix, jx)]
    else:
        return Constraint.Skip
...
def ic_ngc_rule(m, ix, jx, c):
    if 0 < jx <= m.ncp_x:
        return m.Ngc[0, 0, ix, jx, c] == m.Ngc_ic[(ix, jx, c)]
    else:
        return Constraint.Skip

def ic_hgc_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.Hgc[0, 0, ix, jx] == m.Hgc_ic[(ix, jx)]
    else:
        return Constraint.Skip
...
def ic_nsc_rule(m, ix, jx, c):
    if 0 < jx <= m.ncp_x:
        return m.Nsc[0, 0, ix, jx, c] == m.Nsc_ic[(ix, jx, c)]
    else:
        return Constraint.Skip

def ic_hsc_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.Hsc[0, 0, ix, jx] == m.Hsc_ic[(ix, jx)]
    else:
        return Constraint.Skip
...
def ic_nge_rule(m, ix, jx, c):
    if 0 < jx <= m.ncp_x:
        return m.Nge[0, 0, ix, jx, c] == m.Nge_ic[(ix, jx, c)]
    else:
        return Constraint.Skip

def ic_hge_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.Hge[0, 0, ix, jx] == m.Hge_ic[(ix, jx)]
    else:
        return Constraint.Skip
...
def ic_nse_rule(m, ix, jx, c):
    if 0 < jx <= m.ncp_x:
        return m.Nse[0, 0, ix, jx, c] == m.Nse_ic[(ix, jx, c)]
    else:
        return Constraint.Skip
...
def ic_hse_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.Hse[0, 0, ix, jx] == m.Hse_ic[(ix, jx)]
    else:
        return Constraint.Skip
...
def ngc_rule(m, it, jt, ix, jx, c):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Ngc[it, jt, ix, jx, c] == \
               (m.Ax * m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] * m.ed[it, jt, ix, jx] * exp(m.wcc[it, jt, ix, jx, c]))
    else:
        return Constraint.Skip
# Tgc
def hgc_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Hgc[it, jt, ix, jx] == \
               (m.Ax * m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] * m.ed[it, jt, ix, jx] * sum(exp(m.wcc[it, jt, ix, jx, kx]) for kx in m.sp) * m.cpg_mol * m.Tgc[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def nsc_rule(m, it, jt, ix, jx, c):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Nsc[it, jt, ix, jx, c]/m.rhos == \
               (m.Ax * m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] * (1 - m.ed[it, jt, ix, jx]) * m.nc[it, jt, ix, jx, c])
    else:
        return Constraint.Skip
...
def hsc_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Hsc[it, jt, ix, jx] == \
               (m.Ax * m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] * (1 - m.ed[it, jt, ix, jx]) * m.rhos * m.cps * m.Tsc[it, jt, ix, jx]) 
    else:
        return Constraint.Skip
...
def nge_rule(m, it, jt, ix, jx, c):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Nge[it, jt, ix, jx, c] == \
               (m.Ax * (1. - m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] - m.delta[it, jt, ix, jx]) * m.ed[it, jt, ix, jx] * m.ce[it, jt, ix, jx, c])
    else:
        return Constraint.Skip
...
def hge_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Hge[it, jt, ix, jx] == (m.Ax * (1. - m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] - m.delta[it, jt, ix, jx]) * m.ed[it, jt, ix, jx] * sum(m.ce[it, jt, ix, jx, kx] for kx in m.sp) * m.cpg_mol * m.Tge[it, jt, ix, jx]) 
    else:
        return Constraint.Skip
...
def nse_rule(m, it, jt, ix, jx, c):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Nse[it, jt, ix, jx, c] == (m.Ax * (1. - m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] - m.delta[it, jt, ix, jx]) * (1. - m.ed[it, jt, ix, jx]) * m.rhos * m.ne[it, jt, ix, jx, c])
    else:
        return Constraint.Skip
...
def hse_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Hse[it, jt, ix, jx]/m.rhos == (m.Ax * (1. - m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] - m.delta[it, jt, ix, jx]) * (1. - m.ed[it, jt, ix, jx]) * m.cps * m.Tse[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def fdvar_t_ngb(m, it, kt, ix, kx, c):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dNgb_dt[it, kt, ix, kx, c] == (sum(m.ldot_t[jt, kt] * m.Ngb[it, jt, ix, kx, c] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_hgb(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dHgb_dt[it, kt, ix, kx] == (sum(m.ldot_t[jt, kt] * m.Hgb[it, jt, ix, kx] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_ngc(m, it, kt, ix, kx, c):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dNgc_dt[it, kt, ix, kx, c] == (sum(m.ldot_t[jt, kt] * m.Ngc[it, jt, ix, kx, c] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_hgc(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return (m.dHgc_dt[it, kt, ix, kx]) == (sum(m.ldot_t[jt, kt] * m.Hgc[it, jt, ix, kx] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_nsc(m, it, kt, ix, kx, c):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dNsc_dt[it, kt, ix, kx, c] == (sum(m.ldot_t[jt, kt] * m.Nsc[it, jt, ix, kx, c] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_hsc(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dHsc_dt[it, kt, ix, kx] == (sum(m.ldot_t[jt, kt] * m.Hsc[it, jt, ix, kx] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_nge(m, it, kt, ix, kx, c):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dNge_dt[it, kt, ix, kx, c] == (sum(m.ldot_t[jt, kt] * m.Nge[it, jt, ix, kx, c] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_hge(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dHge_dt[it, kt, ix, kx] == (sum(m.ldot_t[jt, kt] * m.Hge[it, jt, ix, kx] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_nse(m, it, kt, ix, kx, c):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dNse_dt[it, kt, ix, kx, c] == (sum(m.ldot_t[jt, kt] * m.Nse[it, jt, ix, kx, c] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fdvar_t_hse(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return m.dHse_dt[it, kt, ix, kx] == (sum(m.ldot_t[jt, kt] * m.Hse[it, jt, ix, kx] for jt in m.cp_t if jt <= m.ncp_t))
    else:
        return Constraint.Skip
...
def fcp_t_ngb(m, it, ix, kx, c):
    if it < (m.nfe_t - 1) and 0 < kx <= m.ncp_x:
...
def a14_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Jc[it, jt, ix, jx] == (m.fw * m.delta[it, jt, ix, jx] * m.rhos * (1 - m.ed[it, jt, ix, jx]) * m.vb[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def a15_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.cb[it, jt, ix, jx, k] == (exp(m.wyb[it, jt, ix, jx, k]) * sum(m.cb[it, jt, ix, jx, kx] for kx in m.sp))
    else:
        return Constraint.Skip
...
def a16_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (1000/1) * (exp(m.wcc[it, jt, ix, jx, k])) == (exp(m.wyc[it, jt, ix, jx, k]) * sum(exp(m.wcc[it, jt, ix, jx, kx]) for kx in m.sp)) * (1000/1)
    else:
        return Constraint.Skip
...
def a17_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.ce[it, jt, ix, jx, k]) == (exp(m.wye[it, jt, ix, jx, k]) * sum(m.ce[it, jt, ix, jx, kx] for kx in m.sp))
    else:
        return Constraint.Skip
...
def a25_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.rhog[it, jt, ix, jx] == (m.P[it, jt, ix, jx] * 100 * (exp(m.wye[it, jt, ix, jx, 'c']) * 44.01 + exp(m.wye[it, jt, ix, jx, 'n']) * 28.01 + exp(m.wye[it, jt, ix, jx, 'h']) * 18.02) / (8.314 * (m.Tge[it, jt, ix, jx] + 273.16)))
    else:
        return Constraint.Skip
...
def a26_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Ar[it, jt, ix, jx] == ((m.dp ** 3) * m.rhog[it, jt, ix, jx] * (m.rhos - m.rhog[it, jt, ix, jx]) * m.gc / (m.mug ** 2))
    else:
        return Constraint.Skip
...
def a29_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.db0[it, jt]) == (1.38 * (m.gc ** (-0.2)) * ((m.vg[it, jt, 0, 1] - exp(m.wve[it, jt, 0, 1])) * m.Ao) ** 0.4)
    else:
        return Constraint.Skip
...
def a31_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dbm[it, jt, ix, jx]) == (2.59 * (m.gc ** (-0.2)) * ((m.vg[it, jt, ix, jx] - exp(m.wve[it, jt, ix, jx])) * m.Ax) ** 0.4)
    else:
        return Constraint.Skip
...
def a32_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.g1[it, jt]) == (2.56E-2 * sqrt(m.Dt / m.gc) / exp(m.wvmf[it, jt]))
    else:
        return Constraint.Skip
...
def a35_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (exp(0.3 * (m.l[ix, jx]) / m.Dt) * (((sqrt(m.dbu[it, jt, ix, jx]) - sqrt(m.dbe[it, jt, ix, jx])) / (sqrt(m.db0[it, jt]) - sqrt(m.dbe[it, jt, ix, jx]))) ** (1 - m.g1[it, jt] / m.g3[it, jt, ix, jx]))) == \
...
def a36_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.fc[it, jt, ix, jx]) == (3. * (exp(m.wvmf[it, jt]) / m.emf) / (m.vbr[it, jt, ix, jx] - (exp(m.wvmf[it, jt]) / m.emf)))
    else:
        return Constraint.Skip
...
def a40_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Kcebs[it, jt, ix, jx]) == \
               (3 * (1 - m.ed[it, jt, ix, jx]) / ((1 - m.delta[it, jt, ix, jx]) * m.ed[it, jt, ix, jx]) * (exp(m.wve[it, jt, ix, jx]) / m.db[it, jt, ix, jx]))
    else:
        return Constraint.Skip
...
def a41_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Hbc[it, jt, ix, jx]) == (1.32 * 4.5 * exp(m.wvmf[it, jt]) * sum(m.cb[it, jt, ix, jx, kx] for kx in m.sp) * m.cpg_mol / m.db[it, jt, ix, jx] + \
...
def a42_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Hce[it, jt, ix, jx]) == (6.78 * sqrt(m.ed[it, jt, ix, jx] * m.vb[it, jt, ix, jx] * (m.kg / 1000) * sum(exp(m.wcc[it, jt, ix, jx, kx]) for kx in m.sp) * m.cpg_mol / (m.db[it, jt, ix, jx] ** 3)))
    else:
        return Constraint.Skip
...
def a44_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Red[it, jt, ix, jx]) == (exp(m.wve[it, jt, ix, jx]) * m.dp * m.rhog[it, jt, ix, jx] / m.mug)
    else:
        return Constraint.Skip
...
def a46_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.kpa[it, jt, ix, jx]) == ((3.58 - 2.5 * m.ed[it, jt, ix, jx]) * m.kg * ((m.kp / m.kg) ** (0.46 - 0.46 * m.ed[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a47_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.fn[it, jt, ix, jx]) == (m.vg[it, jt, ix, jx] / exp(m.wvmf[it, jt]))
    else:
        return Constraint.Skip
...
def a48_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.tau[it, jt, ix, jx]) == (0.44 * ((m.dp * m.gc / ((exp(m.wvmf[it, jt]) ** 2) * ((m.fn[it, jt, ix, jx] - m.ah) ** 2))) ** 0.14) * ((m.dp / m.dx) ** 0.225))
    else:
        return Constraint.Skip
...
def a49_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.fb[it, jt, ix, jx]) == (0.33 * (((exp(m.wvmf[it, jt]) ** 2) * ((m.fn[it, jt, ix, jx] - m.ah) ** 2) / (m.dp * m.gc)) ** 0.14))
    else:
        return Constraint.Skip
...
def a50_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.hd[it, jt, ix, jx]) == (2 * sqrt((m.kpa[it, jt, ix, jx] / 1000) * m.rhos * m.cps * (1 - m.ed[it, jt, ix, jx]) / (m.pi * m.tau[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a51_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (10**4) * (1000 * exp(m.whl[it, jt, ix, jx]) * m.dp / m.kg) == (0.009 * (m.Ar[it, jt, ix, jx] ** 0.5) * (m.Pr ** 0.33)) * (10**4)
    else:
        return Constraint.Skip
...
def a52_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.ht[it, jt, ix, jx]) == (m.fb[it, jt, ix, jx] * m.hd[it, jt, ix, jx] + (1 - m.fb[it, jt, ix, jx]) * exp(m.whl[it, jt, ix, jx]))
    else:
        return Constraint.Skip
...
def a55_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.ht[it, jt, ix, jx] * m.dThx[it, jt, ix, jx] * m.Cr) == (m.hw * (m.Thx[it, jt, ix, jx] - m.Ttube[it, jt, ix, jx]))
    else:
        return Constraint.Skip
...
def a57_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (10 * 1.75 / (m.phis * m.emf ** 3) * (m.dp * exp(m.wvmf[it, jt]) * m.rhog[it, jt, 0, 1] / m.mug) ** 2 + \
               10 * 150 * (1 - m.emf) / ((m.phis ** 2) * (m.emf ** 3)) * (
               m.dp * exp(m.wvmf[it, jt]) * m.rhog[it, jt, 0, 1] / m.mug)) \
               == \
               (10 * m.dp ** 3 * m.rhog[it, jt, 0, 1] * (m.rhos - m.rhog[it, jt, 0, 1]) * m.gc / m.mug ** 2)
    else:
        return Constraint.Skip
...
def a58_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        ...
        return (10**4)*(log(m.k1c[it, jt, ix, jx]) - log(m.A1 * (m.Tsc[it, jt, ix, jx] + 273.15))) == ((-m.E1 / (m.R * (m.Tsc[it, jt, ix, jx] + 273.15))))*(10**4)
    else:
        return Constraint.Skip
...
def a61_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (10**4)*(log(m.k1e[it, jt, ix, jx]) - log(m.A1 * (m.Tse[it, jt, ix, jx] + 273.15))) == ((-m.E1 / (m.R * (m.Tse[it, jt, ix, jx] + 273.15))))*(10**4)
    else:
        return Constraint.Skip
...
def a64_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Ke1c[it, jt, ix, jx] * m.P[it, jt, ix, jx] * 1E5) == (exp(-m.dH1 / (m.R * (m.Tsc[it, jt, ix, jx] + 273.15)) + m.dS1 / m.R))
    else:
        return Constraint.Skip
...
def a70_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((100)*m.r1c[it, jt, ix, jx] / 1E5) == \
               ((m.k1c[it, jt, ix, jx] * ((m.P[it, jt, ix, jx] * exp(m.wyc[it, jt, ix, jx, 'h'])) - (m.nc[it, jt, ix, jx, 'h'] * m.rhos / m.Ke1c[it, jt, ix, jx]) / 1E5))*100)
    else:
        return Constraint.Skip
...
def a71_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.r2c[it, jt, ix, jx] / 1E5) == (m.k2c[it, jt, ix, jx] * ((1 - 2 * (m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.nc[it, jt, ix, jx, 'h'] * m.rhos * m.P[it, jt, ix, jx] * exp(m.wyc[it, jt, ix, jx, 'c']) * 1E5 -(((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv))*m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.Ke2c[it, jt, ix, jx]))/1E5)
    else:
        return Constraint.Skip
...
def a72_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.r3c[it, jt, ix, jx]) == (m.k3c[it, jt, ix, jx] * (((1 - 2 * (m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) ** 2) * ((m.P[it, jt, ix, jx] * exp(m.wyc[it, jt, ix, jx, 'c']) * 1E5) ** m.m1) - ((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) * ((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) / m.Ke3c[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a73_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (100 * m.r1e[it, jt, ix, jx] / 1E5) == (m.k1e[it, jt, ix, jx] * ((m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'h'])) - (1e-05)*(m.ne[it, jt, ix, jx, 'h'] * m.rhos / m.Ke1e[it, jt, ix, jx]))*100)
    else:
        return Constraint.Skip
...
def a74_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((m.r2e[it, jt, ix, jx] / m.k2e[it, jt, ix, jx]) / (1e+04))== \
               (((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.ne[it, jt, ix, jx, 'h'] * m.rhos * (m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'c']) * 1E5) - (((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) +  (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.Ke2e[it, jt, ix, jx])) / (1e+04))
    else:
        return Constraint.Skip
...
def a75_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((m.r3e[it, jt, ix, jx] / m.k3e[it, jt, ix, jx])/(1e+04))  == ((((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) ** 2) * (((m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'c'])) ** m.m1) * 1E5 ** m.m1) -
...
def a89_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.hse[it, jt, ix, jx]) == (((m.ne[it, jt, ix, jx, 'h'] + m.ne[it, jt, ix, jx, 'c']) * (m.cpgcse['h'] * m.Tse[it, jt, ix, jx] + m.dH1) +
                                         ...
                                         m.ne[it, jt, ix, jx, 'n'] * (
                                         m.cpgcse['c'] * m.Tse[it, jt, ix, jx] + m.dH3)) * 1E-3 + m.cps * m.Tse[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def de_ngc_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k != "n":
        return ((1e+04) * m.dNgc_dt[it, jt, ix, jx, k]/m.delta[it, jt, ix, jx]) == (m.Kbc[it, jt, ix, jx, k] * (m.cb[it, jt, ix, jx, k] - exp(m.wcc[it, jt, ix, jx, k])) - \
                                           m.Kce[it, jt, ix, jx, k] * (exp(m.wcc[it, jt, ix, jx, k]) - m.ce[it, jt, ix, jx, k]) - \
                                           m.fcw[it, jt, ix, jx] * (1. - m.ed[it, jt, ix, jx]) * m.rgc[it, jt, ix, jx, k]) * (1e+04) * m.hi_t[it]
    elif 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k == "n":
        return ((1e+04) * m.dNgc_dt[it, jt, ix, jx, k]/m.delta[it, jt, ix, jx]) == \
               (m.Kbc[it, jt, ix, jx, k] * (m.cb[it, jt, ix, jx, k] - exp(m.wcc[it, jt, ix, jx, k])) - m.Kce[it, jt, ix, jx, k] * (exp(m.wcc[it, jt, ix, jx, k])- m.ce[it, jt, ix, jx, k])) * (1e+04) * m.hi_t[it]
    else:
        return Constraint.Skip
...
def de_hgc_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dHgc_dt[it, jt, ix, jx] / m.delta[it, jt, ix, jx]) == (m.hi_t[it]) * \
...
def de_hsc_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dHsc_dt[it, jt, ix, jx] * m.hi_x[ix]) \
               == (m.hi_t[it]) * (-m.decwin_dx[it, jt, ix, jx] * m.Ax - m.Hsbulk[it, jt, ix, jx] - \
...
def de_nge_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k != "n":
        ...
        exp(m.wcc[it, jt, ix, jx, k]) - m.ce[it, jt, ix, jx, k]) - \
                   ...
                   m.Kgbulk[it, jt, ix, jx, k] / m.hi_x[ix]) * (1e+03) * m.hi_t[it]
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k == "n":
        return ((1e+03) * m.dNge_dt[it, jt, ix, jx, k]) \
               == (m.Ax * m.delta[it, jt, ix, jx] * m.Kce[it, jt, ix, jx, k] * (
        exp(m.wcc[it, jt, ix, jx, k]) - m.ce[it, jt, ix, jx, k]) - \
...
def de_hge_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dHge_dt[it, jt, ix, jx]) \
               == (m.hi_t[it]) * (m.Ax * m.delta[it, jt, ix, jx] * m.Hce[it, jt, ix, jx] * (
...
def de_nse_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dNse_dt[it, jt, ix, jx, k] * m.hi_x[ix]) == \
               (m.hi_t[it]) * (m.dcein_dx[it, jt, ix, jx, k] * m.Ax + m.Ksbulk[it, jt, ix, jx, k] + \
...
def de_hse_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.dHse_dt[it, jt, ix, jx] * m.hi_x[ix]) == \
               (m.hi_t[it]) * (m.deein_dx[it, jt, ix, jx] * m.Ax + m.Hsbulk[it, jt, ix, jx] + \
                m.hi_x[ix] * m.Ax * m.delta[it, jt, ix, jx] * m.rhos * m.Kcebs[it, jt, ix, jx] * (
...
def i1_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Kgbulk[it, jt, ix, jx, k]) == (m.K_d * (sum(m.ce[it, jt, ix, jx, kx] for kx in m.sp) - sum(m.cb[it, jt, ix, jx, kx] for kx in m.sp)) * exp(m.wyb[it, jt, ix, jx, k]))
    else:
        return Constraint.Skip
...
def i2_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Hgbulk[it, jt, ix, jx]) == (m.K_d * (sum(m.ce[it, jt, ix, jx, kx] for kx in m.sp) - sum(m.cb[it, jt, ix, jx, kx] for kx in m.sp)) * m.cpg_mol * m.Tgb[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def i4_rule(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return (m.Hsbulk[it, kt, ix, kx]) == \
               (-m.Ax * sum(m.lydot[jx, kx] * m.Jc[it, kt, ix, jx] for jx in m.cp_x if 0 < jx <= m.ncp_x) * m.hse[it, kt, ix, kx])
    else:
        return Constraint.Skip
...
def i6_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.vb[it, jt, ix, jx]) == (1.55 * ((m.vg[it, jt, ix, jx] - exp(m.wvmf[it, jt])) + 14.1 * (m.db[it, jt, ix, jx] + 0.005)) * (m.Dte ** 0.32) + m.vbr[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def i7_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((1 - m.emf) * ((m.dp ** 0.1) * (m.gc ** 0.118) * 2.05 * (m.l[ix, jx] ** 0.043))) == (2.54 * (m.mug ** 0.066) * (1. - m.ed[it, jt, ix, jx]))
    else:
        return Constraint.Skip
...
def i8_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (1000/1) * (exp(m.wve[it, jt, ix, jx]) * ((m.dp ** 0.568) * (m.gc ** 0.663) * (0.08518 * (m.rhos - m.rhog[it, jt, ix, jx]) + 19.09) * ((m.l[ix, jx]) ** 0.244))) == ((exp(m.wvmf[it, jt]) * 188. * 1.02 * (m.mug ** 0.371))) * (1000/1)
    else:
        return Constraint.Skip
...
def fdvar_z_(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return (m.dz_dx[it, kt, ix, kx]) == (sum(m.ldot_x[jx, kx] * m.z[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip

# ceini0
def fcp_x_cein(m, it, kt, ix, c):
    if 0 < kt <= m.ncp_t and ix < (m.nfe_x - 1):
        return (m.cein[it, kt, ix + 1, 0, c]) == (sum(m.l1_x[jx] * m.cein[it, kt, ix, jx, c] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fcp_x_ecwin(m, it, kt, ix):
    if 0 < kt <= m.ncp_t and ix < (m.nfe_x - 1):
        return (m.ecwin[it, kt, ix + 1, 0]) == (sum(m.l1_x[jx] * m.ecwin[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fcp_x_eein(m, it, kt, ix):
    if 0 < kt <= m.ncp_t and ix < (m.nfe_x - 1):
        return (m.eein[it, kt, ix + 1, 0]) == (sum(m.l1_x[jx] * m.eein[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fzl_cein(m, it, kt, c):
    if 0 < kt <= m.ncp_t:
        return (m.cein_l[it, kt, c]) == (sum(m.l1_x[jx] * m.cein[it, kt, (m.nfe_x - 1), jx, c] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fzl_ecwin(m, it, kt):
    if 0 < kt <= m.ncp_t:
        return (m.ecwin_l[it, kt]) == (sum(m.l1_x[jx] * m.ecwin[it, kt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip

def fzl_eein(m, it, kt):
    if 0 < kt <= m.ncp_t:
        return (m.eein_l[it, kt]) == (sum(m.l1_x[jx] * m.eein[it, kt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip

def fzl_hxh(m, it, kt):
    if 0 < kt <= m.ncp_t:
        return (m.hxh_l[it, kt]) == (sum(m.l1_x[jx] * m.hxh[it, kt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip

def fzl_phx(m, it, kt):
    if 0 < kt <= m.ncp_t:
        return (m.Phx_l[it, kt]) == (sum(m.l1_x[jx] * m.Phx[it, kt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip

def fzl_ccwin(m, it, kt, c):
    if 0 < kt <= m.ncp_t:
        return (m.ccwin_l[it, kt, c]) == (sum(m.l1_x[jx] * m.ccwin[it, kt, (m.nfe_x - 1), jx, c] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fyl_hse(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.hse_l[it, jt]) == (sum(m.l1y[jx] * m.hse[it, jt, (m.nfe_x - 1), jx] for jx in m.cp_x if 0 < jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fyl_ne(m, it, jt, c):
    if 0 < jt <= m.ncp_t:
        return (m.ne_l[it, jt, c]) == (sum(m.l1y[jx] * m.ne[it, jt, (m.nfe_x - 1), jx, c] for jx in m.cp_x if 0 < jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fzl_cb(m, it, jt, c):
    if 0 < jt <= m.ncp_t:
        return (m.cb_l[it, jt, c]) == (sum(m.l1_x[jx] * m.cb[it, jt, (m.nfe_x - 1), jx, c] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def cc_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.c_capture[it, jt]) == (1 - (m.GasOut_F[it, jt] * m.GasOut_z[it, jt, 'c']) / (m.GasIn_F[it] * m.GasIn_z[it, 'c']))
    else:
        return Constraint.Skip
...
def fdvar_x_vg_(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return (m.dvg_dx[it, kt, ix, kx]) == (sum(m.ldot_x[jx, kx] * m.vg[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fcp_x_cb(m, it, kt, ix, c):
    if 0 < kt <= m.ncp_t and ix < (m.nfe_x - 1):
        return (m.cb[it, kt, ix + 1, 0, c]) == (sum(m.l1_x[jx] * m.cb[it, kt, ix, jx, c] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fcp_x_P(m, it, kt, ix):
    if 0 < kt <= m.ncp_t and ix < (m.nfe_x - 1):
        return (m.P[it, kt, ix + 1, 0]) == (sum(m.l1_x[jx] * m.P[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def fdvar_x_dvg_dx_(m, it, kt, ix, kx):
    if 0 < kt <= m.ncp_t and 0 < kx <= m.ncp_x:
        return (m.dvgx_dx[it, kt, ix, kx]) == (sum(m.ldot_x[jx, kx] * m.vgx[it, kt, ix, jx] for jx in m.cp_x if jx <= m.ncp_x))
    else:
        return Constraint.Skip
...
def hgb_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.Hgb[it, jt, ix, jx]) == (m.delta[it, jt, ix, jx] * sum(m.cb[it, jt, ix, jx, c] for c in m.sp) * m.cpg_mol * m.Tgb[it, jt, ix, jx])
    else:
        return Constraint.Skip
...
def alt_de_Gb_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.hi_x[ix] * m.dmom_dt[it, jt, ix, jx]) == (\
               ...
               m.hi_x[ix] * (1 - m.e[it, jt, ix, jx]) * m.rhos * m.gc) * m.hi_t[it]
    else:
        return Constraint.Skip
...
def de_ngb_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.hi_x[ix] * m.dNgb_dt[it, jt, ix, jx, k]) == \
               ...
               m.Kgbulk[it, jt, ix, jx, k]/m.Ax) * m.hi_t[it]
    else:
        return Constraint.Skip
...
def de_hgb_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (1e+02) * (m.hi_x[ix] * m.dHgb_dt[it, jt, ix, jx]) == \
               ...
               m.Hgbulk[it, jt, ix, jx]/m.Ax) * (1e+02) * m.hi_t[it]
    else:
        return Constraint.Skip
...
def dpdx_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((m.dP_dx[it, jt, ix, jx]) * 100/8.314) == (sum(m.cb[it, jt, ix, jx, kx] for kx in m.sp) * m.dTgb_dx[it, jt, ix, jx] + (m.Tgb[it, jt, ix, jx] + 273.16) * sum(m.dcb_dx[it, jt, ix, jx, kx] for kx in m.sp))
    else:
        return Constraint.Skip
...
def dhxh_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return 0 == ((m.HXIn_F / 3600) * m.dhxh_dx[it, jt, ix, jx] - m.hi_x[ix] * 1E-6 * m.pi * m.dx * m.ht[it, jt, ix, jx] * m.dThx[it, jt, ix, jx] * m.Nx * m.Cr)
    else:
        return Constraint.Skip
...
def bc_Gb0_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.Gb[it, jt, 0, 0]) == (m.GasIn_F[it] / 3600)
    else:
        return Constraint.Skip
...
def bc_Tgb0_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.Tgb[it, jt, 0, 0]) == (m.GasIn_T[it])
    else:
        return Constraint.Skip
...
def bc_cb0_rule(m, it, jt, k):
    if 0 < jt <= m.ncp_t:
        return (m.cb[it, jt, 0, 0, k]) == (m.GasIn_z[it, k] * m.GasIn_P[it] * 100 / (8.314 * (m.GasIn_T[it] + 273.16)))
    else:
        return Constraint.Skip
...
def bc_P0_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.P[it, jt, 0, 0]) == (m.GasIn_P[it])
    else:
        return Constraint.Skip
...
def bc_vg0_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.vg[it, jt, 0, 0]) == (m.GasIn_F[it] / (3600 * m.Ax * m.GasIn_P[it] * 100 / (8.314 * (m.GasIn_T[it] + 273.16))))
    else:
        return Constraint.Skip
...
def bc_vgx_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (sum(m.l1_x[jx] * m.vgx[it, jt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x)) == 0.0
    else:
        return Constraint.Skip
...
def bc_cbx_rule(m, it, jt, c):
    if 0 < jt <= m.ncp_t:
        return (sum(m.l1_x[jx] * m.cbx[it, jt, (m.nfe_x - 1), jx, c] for jx in m.cp_x if jx <= m.ncp_x)) == 0.0
    else:
        return Constraint.Skip
...
def bc_Tgbx_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (sum(m.l1_x[jx] * m.Tgbx[it, jt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x)) == 0.0
    else:
        return Constraint.Skip
...
def e12_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return ((1e+04) * sum(m.l1_x[jx] * m.vg[it, jt, (m.nfe_x - 1), jx] * sum(m.cb[it, jt, (m.nfe_x - 1), jx, kx] for kx in m.sp) for jx in m.cp_x if 0 < jx <= m.ncp_x)) == ((m.GasOut_F[it, jt] / (3600 * m.Ax))* (1e+04))
    else:
        return Constraint.Skip
...
def e13_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (sum(m.l1_x[jx] * m.Tgb[it, jt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x)) == (m.GasOut_T[it, jt])
    else:
        return Constraint.Skip
...
def e20_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.Sit[it] - m.Sot[it, jt]) == (sum(m.l1_x[jx] * m.z[it, jt, (m.nfe_x - 1), jx] for jx in m.cp_x if jx <= m.ncp_x) * m.Ax)
    else:
        return Constraint.Skip
...
def bc_mol0_rule(m, it, jt, c):
    if 0 < jt <= m.ncp_t:
        return (m.ccwin[it, jt, 0, 0, c]) == (m.cein[it, jt, 0, 0, c])
    else:
        return Constraint.Skip
...
def bc_ene0_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (m.ecwin[it, jt, 0, 0]) == (m.eein[it, jt, 0, 0])
    else:
        return Constraint.Skip
...
def ic_mom_rule(m, ix, jx):
    if 0 < jx <= m.ncp_x:
        return m.mom[0, 0, ix, jx] == m.mom_ic[(ix, jx)]
    else:
        return Constraint.Skip
