...
class bfb_dae(ConcreteModel):
    def __init__(self, nfe_t, ncp_t, **kwargs):
        ...
        self.whl = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, initialize=-4.5384, bounds=(-50, 5))
        ...
        self.wve = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, initialize=-3.5, bounds=(-50,5))
        ...
        self.wyb = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, self.sp, initialize=lambda m, i, j, k, l, s: wyb[s], bounds=(-50, 5))
        # self.yc = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, self.sp, initialize=1.)
        self.wyc = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, self.sp, initialize=lambda m, i, j, k, l, s: wyc[s], bounds=(-50, 5))
        #self.ye = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, self.sp, initialize=1.)
        self.wye = Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, self.sp, initialize=lambda m, i, j, k, l, s: wye[s], bounds=(-50, 5))
