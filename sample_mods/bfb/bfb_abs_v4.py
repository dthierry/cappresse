...
class bfb_dae(ConcreteModel):
    def __init__(self, nfe_t, ncp_t, **kwargs):
        ...
        self.u3 = Param(self.fe_t, initialize=583860.584859, mutable=True)

        self.GasIn_F = Var(self.fe_t, initialize=9937.98446662)
        self.GasOut_F = Var(self.fe_t, initialize=9286.03346463)
        self.SolidIn_Fm = Var(self.fe_t, initialize=583860.584859)
        ...
        self.u3_e = Expression(self.fe_t, rule=lambda m, i: self.SolidIn_Fm[i])
        ...
        self.u3_c = Constraint(self.fe_t, rule=lambda m, i: self.u3[i] == self.u3_e[i])
        # --------------------------------------------------------------------------------------------------------------
            ...
            for jt in range(1, self.ncp_t + 1):
                for ix in range(1, self.nfe_x + 1):
                    for jx in range(0, self.ncp_x + 1):
                        ...
                        self.Ke3e[it, jt, ix, jx].setlb(1e-09)
    ...
    def equalize_u(self, direction="u_to_r"):
        ...
        if direction == "u_to_r":
            ...
            for i in self.SolidIn_Fm.keys():
                self.SolidIn_Fm[i].set_value(value(self.u3[i]))
            ...
            for i in self.u3.keys():
                self.u3[i].value = value(self.SolidIn_Fm[i])
