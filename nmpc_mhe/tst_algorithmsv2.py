...
from nmpc_mhe.mods.bfb.nob5 import bfb_dae
...
e.solve_dyn(e.lsmhe,
            skip_update=False,
            max_cpu_time=600,
            ma57_pre_alloc=5)  #: Pre-loaded mhe solve
...
for i in range(1, 1000):
    ...
    stat_nmpc = e.solve_dyn(e.olnmpc, skip_update=False, max_cpu_time=300, jacobian_regularization_value=1e-04)
    e.olnmpc.hi_t.display()
    # if stat_nmpc != 0:
