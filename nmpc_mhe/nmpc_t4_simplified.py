...
from nmpc_mhe.mods.bfb.bfb_abs7momdt_nmpc_simplified import bfb_dae
...
c = NmpcGen(d_mod=bfb_dae, u=u, states=states, ref_state=ref_state, u_bounds=u_bounds, nfe_t=5)
...
for i in range(1, 1000):
    ...
    if stat_nmpc != 0:
        ...
        stat_nmpc = c.solve_d(c.olnmpc, stop_if_nopt=True, skip_update=False, max_cpu_time=700)
    c.update_u(c.olnmpc)
    c.print_r_nmpc()
    ...
    for x in c.states:
        ...
        for ks in x_ic.keys():
            ...
            v_tgt[(1, 0) + ks].set_value(x_ic[ks].value)
