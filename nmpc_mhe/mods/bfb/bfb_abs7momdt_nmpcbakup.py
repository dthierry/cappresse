...
class bfb_dae(ConcreteModel):
    def __init__(self, nfe_t, ncp_t, **kwargs):
        ...
        def a71_rulex(m, it, jt, ix, jx):
            if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
                ...
                ((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.nc[
                    it, jt, ix, jx, 'c'] * m.rhos / m.Ke2c[it, jt, ix, jx]))
            else:
                return Constraint.Skip
        ...
        def a72_rulex(m, it, jt, ix, jx):
            if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
                return m.r3c[it, jt, ix, jx] == exp(m.wk3c[it, jt, ix, jx]) * (((1 - 2 * (m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) ** 2) * ((m.P[it, jt, ix, jx] * m.yc[it, jt, ix, jx, 'c'] * 1E5) ** m.m1) - ((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) * ((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) /m.Ke3c[it, jt, ix, jx]))
            else:
                return Constraint.Skip
        ...
        def a74_rulex(m, it, jt, ix, jx):
            if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
                return m.r2e[it, jt, ix, jx] / (1e+04) == exp(m.wk2e[it, jt, ix, jx]) * ((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (
                       m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.ne[it, jt, ix, jx, 'h'] * m.rhos * (
                        ...
                        m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.Ke2e[it, jt, ix, jx])) / (1e+04)
            else:
                return Constraint.Skip
        ...
        def a75_rulex(m, it, jt, ix, jx):
            if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
                return m.r3e[it, jt, ix, jx] == exp(m.wk3e[it, jt, ix, jx]) * (((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) ** 2) * (((m.P[it, jt, ix, jx] * m.ye[it, jt, ix, jx, 'c']) ** m.m1) * 1E5 ** m.m1) - ((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) * ((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) /m.Ke3e[it, jt, ix, jx]))
            else:
                return Constraint.Skip
                ...
                for ix in range(1, self.nfe_x + 1):
                    for jx in range(0, self.ncp_x + 1):
                        for cx in ['c', 'h', 'n']:
                            ...
                            self.yb[it, jt, ix, jx, cx].setlb(1e-06)
                            self.yc[it, jt, ix, jx, cx].setlb(1e-06)
                            self.ye[it, jt, ix, jx, cx].setlb(1e-06)
