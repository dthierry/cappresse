...
def a59_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return log(m.k2c[it, jt, ix, jx]) - log(m.A2 * (m.Tsc[it, jt, ix, jx] + 273.15)) == (-m.E2 / (m.R * (m.Tsc[it, jt, ix, jx] + 273.15)))
    else:
        return Constraint.Skip
...
def a60_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return log(m.k3c[it, jt, ix, jx]) - log(m.A3 * (m.Tsc[it, jt, ix, jx] + 273.15)) == (-m.E3 / (m.R * (m.Tsc[it, jt, ix, jx] + 273.15)))
    else:
        return Constraint.Skip
...
def a62_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return log(m.k2e[it, jt, ix, jx]) - log(m.A2 * (m.Tse[it, jt, ix, jx] + 273.15)) == (-m.E2 / (m.R * (m.Tse[it, jt, ix, jx] + 273.15)))
    else:
        return Constraint.Skip
...
def a63_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return log(m.k3e[it, jt, ix, jx]) - log(m.A3 * (m.Tse[it, jt, ix, jx] + 273.15)) == (-m.E3 / (m.R * (m.Tse[it, jt, ix, jx] + 273.15)))
    else:
        return Constraint.Skip
...
def a68_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.Ke2e[it, jt, ix, jx] * m.P[it, jt, ix, jx] * 1E5 == exp(-m.dH2 / (m.R * (m.Tse[it, jt, ix, jx] + 273.15)) + m.dS2 / m.R)
    else:
        return Constraint.Skip
    ...
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return m.dHgc_dt[it, jt, ix, jx] == \
               (m.Ax * m.delta[it, jt, ix, jx] * \
                ...
                m.Ax * m.fcw[it, jt, ix, jx] * m.delta[it, jt, ix, jx] * (1 - m.ed[it, jt, ix, jx]) * sum(m.rgc[it, jt, ix, jx, k] * m.cpgcgc[k] for k in m.sp) * m.Tgc[it, jt, ix, jx]) * m.hi_t[it]
    else:
        return Constraint.Skip
...
def de_ngb_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return 1000*m.hi_x[ix] * m.dNgb_dt[it, jt, ix, jx, k] == \
               ...
               m.hi_t[it] * m.Kgbulk[it, jt, ix, jx, k]/m.Ax)*1000
    else:
        return Constraint.Skip
