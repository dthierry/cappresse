...
def a16_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (exp(m.wcc[it, jt, ix, jx, k])) == (exp(m.wyc[it, jt, ix, jx, k]) * sum(exp(m.wcc[it, jt, ix, jx, kx]) for kx in m.sp))
    else:
        return Constraint.Skip
...
def a51_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (1000 * exp(m.whl[it, jt, ix, jx]) * m.dp / m.kg) == (0.009 * (m.Ar[it, jt, ix, jx] ** 0.5) * (m.Pr ** 0.33))
    else:
        return Constraint.Skip
...
def a70_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.r1c[it, jt, ix, jx]) == \
               ((m.k1c[it, jt, ix, jx] * ((m.P[it, jt, ix, jx] * exp(m.wyc[it, jt, ix, jx, 'h'])) - (m.nc[it, jt, ix, jx, 'h'] * m.rhos / m.Ke1c[it, jt, ix, jx]) )))
    else:
        return Constraint.Skip
...
def a71_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (m.r2c[it, jt, ix, jx]) == (m.k2c[it, jt, ix, jx] * ((1 - 2 * (m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.nc[it, jt, ix, jx, 'h'] * m.rhos * m.P[it, jt, ix, jx] * exp(m.wyc[it, jt, ix, jx, 'c']) * 1E5 -(((m.nc[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.nv))*m.nc[it, jt, ix, jx, 'c'] * m.rhos / m.Ke2c[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a73_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ( m.r1e[it, jt, ix, jx] ) == (m.k1e[it, jt, ix, jx] * ((m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'h'])) - (m.ne[it, jt, ix, jx, 'h'] * m.rhos / m.Ke1e[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a74_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((m.r2e[it, jt, ix, jx] / m.k2e[it, jt, ix, jx]))== \
               (((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.ne[it, jt, ix, jx, 'h'] * m.rhos * (m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'c']) * 1E5) - (((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) +  (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) * m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.Ke2e[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def a75_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return ((m.r3e[it, jt, ix, jx] / m.k3e[it, jt, ix, jx]))  == ((((1. - 2. * (m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) - (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) ** 2) * (((m.P[it, jt, ix, jx] * exp(m.wye[it, jt, ix, jx, 'c'])) ** m.m1) * 1E5 ** m.m1) -
               ((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) * ((m.ne[it, jt, ix, jx, 'n'] * m.rhos / m.nv) + (m.ne[it, jt, ix, jx, 'c'] * m.rhos / m.nv)) /m.Ke3e[it, jt, ix, jx])))
    else:
        return Constraint.Skip
...
def de_ngc_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k != "n":
        ...
        return 0.0 == \
               (m.Kbc[it, jt, ix, jx, k] * (m.cb[it, jt, ix, jx, k] - exp(m.wcc[it, jt, ix, jx, k])) - m.Kce[it, jt, ix, jx, k] * (exp(m.wcc[it, jt, ix, jx, k])- m.ce[it, jt, ix, jx, k]))
    else:
        return Constraint.Skip
...
def de_nge_rule(m, it, jt, ix, jx, k):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k != "n":
        ...
        exp(m.wcc[it, jt, ix, jx, k]) - m.ce[it, jt, ix, jx, k]) - \
                   ...
                   m.Kgbulk[it, jt, ix, jx, k] / m.hi_x[ix])
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x and k == "n":
        return 0.0 \
               == (m.Ax * m.delta[it, jt, ix, jx] * m.Kce[it, jt, ix, jx, k] * (
        exp(m.wcc[it, jt, ix, jx, k]) - m.ce[it, jt, ix, jx, k]) - \
...
def i8_rule(m, it, jt, ix, jx):
    if 0 < jt <= m.ncp_t and 0 < jx <= m.ncp_x:
        return (exp(m.wve[it, jt, ix, jx]) * ((m.dp ** 0.568) * (m.gc ** 0.663) * (0.08518 * (m.rhos - m.rhog[it, jt, ix, jx]) + 19.09) * ((m.l[ix, jx]) ** 0.244))) == ((exp(m.wvmf[it, jt]) * 188. * 1.02 * (m.mug ** 0.371)))
    else:
        return Constraint.Skip
...
def e12_rule(m, it, jt):
    if 0 < jt <= m.ncp_t:
        return (sum(m.l1_x[jx] * m.vg[it, jt, m.nfe_x, jx] * sum(m.cb[it, jt, m.nfe_x, jx, kx] for kx in m.sp) for jx in m.cp_x if 0 < jx <= m.ncp_x)) == ((m.GasOut_F[it, jt] / (3600 * m.Ax)))
    else:
        return Constraint.Skip
