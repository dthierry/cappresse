...
class bfb_dae(ConcreteModel):
    def __init__(self, nfe_t, ncp_t, **kwargs):
        ...
        self.Gb_ic = zero2_x if steady else Param(self.fe_x, self.cp_x, initialize=1., mutable=True)
        ...
        self.dGb_dt = zero4 if steady else Var(self.fe_t, self.cp_ta, self.fe_x, self.cp_x, initialize=0.0001)
