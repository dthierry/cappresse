...
tst = e.solve_d(e.lsmhe, skip_update=False, max_cpu_time=1000,
                jacobian_regularization_value=0.0,
                jacobian_regularization_exponent=2., halt_on_ampl_error=True,
...
if tst != 0:
    ...
    e.solve_d(e.lsmhe, skip_update=False, max_cpu_time=1000,
              jacobian_regularization_value=0.0,
              jacobian_regularization_exponent=2., stop_if_nopt=True, halt_on_ampl_error=True,
