...
from nmpc_mhe.mods.bfb.nob5_r3e0 import bfb_dae
...
e = NmpcGen(bfb_dae, 400/nfe_mhe, states, u, ref_state=ref_state, u_bounds=u_bounds,
...
for i in range(1, 1000):
    ps = e.solve_dyn(e.PlantSample, stop_if_nopt=True)
